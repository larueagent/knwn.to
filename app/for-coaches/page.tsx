  ...
  return (
    <main className="min-h-screen bg-parchment text-[#1A1714] flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
        ...
        <Link
          href="#waitlist"
          className="px-8 py-4 bg-[#1A1714] text-parchment font-syne font-semibold text-sm tracking-wide hover:bg-[#2a2520] transition-colors"
        >
      ...
      <section className="bg-[#1A1714] text-[#E8E0D5] px-6 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="font-inter text-base text-[#8A8178] leading-relaxed">
            ...
            stats — are the ones who grow fastest. Most coaches don&apos;t have the time or
            bandwidth to build that foundation for every athlete on their roster. LaRue does.
            He tracks athlete state over time, surfaces who needs attention before it becomes
            a problem, and connects them to you when they need a real conversation.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center px-6 py-16">
        <div className="max-w-2xl w-full">
          ...
          <h2 className="font-syne font-bold text-3xl text-[#1A1714] mb-10 leading-tight">
            LaRue handles the intake. You do the coaching.
          </h2>
          <div className="flex flex-col gap-8">
            {[
              ...
              {
                n: "02",
                title: "You see your roster clearly",
                body: "Instead of spending the first three sessions doing intake, you start with a full picture of every athlete — who internalizes under pressure, who needs silence before competition, who's been struggling for three weeks. That context is shareable, searchable, and always current.",
              },
              {
                n: "03",
                title: "LaRue flags what needs your attention",
                body: "Your assistant coach monitors athlete state between sessions. When something needs a real conversation, he surfaces it — so you spend your time on the athletes who need you most, not on status checks.",
              },
            ].map(({ n, title, body }) => (
      ...
      <section id="waitlist" className="bg-[#1A1714] text-[#E8E0D5] px-6 py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <h2 className="font-syne font-bold text-3xl text-[#E8E0D5] mb-6 leading-tight">
            The VAC pilot is open.
          </h2>
          <p className="font-inter text-base text-[#8A8178] leading-relaxed mb-4">
            VAC — Virtual Assistant Coach — is LaRue deployed as your assistant coach.
            He knows every athlete on your roster from day one, tracks their readiness
            state across the season, and handles the intake and monitoring work that
            currently lives in your head or doesn&apos;t get done at all.
          </p>
          <p className="font-inter text-base text-[#8A8178] leading-relaxed mb-8">
            We are onboarding a small cohort of coaches for the pilot. If you work with
            competitive athletes and want to be part of the first class, apply below.
          </p>
          <Link
            href="https://momentumlabs.coach"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block px-8 py-4 border border-[#E8E0D5] text-[#E8E0D5] font-syne font-semibold text-sm tracking-wide hover:bg-[#E8E0D5] hover:text-[#1A1714] transition-colors"
          >
            Apply at momentumlabs.coach &rarr;
          </Link>
        </div>
      </section>
      ...
      <section className="flex flex-col items-center px-6 py-16">
        <div className="max-w-2xl w-full">
          ...
          <p className="font-inter text-base text-[#4A443E] leading-relaxed mb-4">
            Most young athletes either get nothing — or get generic. The ones who reach
            elite programs get performance science staff, sport psychologists, and
            individualized mental coaching. Everyone else gets a motivational poster.
          </p>
          <p className="font-inter text-base text-[#4A443E] leading-relaxed mb-4">
            KNWN.TO and LaRue are the athlete-facing layer: an AI-powered system that
            builds genuine self-knowledge in athletes and surfaces it in a format coaches
            can actually use. VAC is the coach-facing layer — LaRue deployed as your
            assistant coach, giving you the roster intelligence and readiness monitoring
            that used to require a full performance science staff.
          </p>
          <p className="font-inter text-base text-[#4A443E] leading-relaxed mb-6">
            Powered by Mettle — built with sport psychologist Alex Auerbach, Ph.D.,
            drawing on 15+ years of work with competitive athletes at every level.
          </p>
