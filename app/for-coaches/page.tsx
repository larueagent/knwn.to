    ...
    <main className="min-h-screen bg-parchment text-[#1A1714] flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
        ...
        <p className="font-inter text-lg text-[#4A443E] max-w-xl leading-relaxed mb-12">
          LaRue helps athletes build a mental performance identity before they ever walk into your office — so you spend less time starting from scratch and more time doing the real work.
        </p>
        <Link
          href="#waitlist"
      ...
      <section className="flex flex-col items-center px-6 py-14">
        <div className="max-w-2xl w-full">
          <p className="font-inter text-lg text-[#1A1714] leading-relaxed mb-3">AI is already in your sport. Scouts use it. Coaches use it. Recruiters use it.</p>
          <p className="font-inter text-base text-[#4A443E] leading-relaxed">
            Most coaches don&apos;t have the time or bandwidth to build that foundation for every athlete on their roster. LaRue does. He tracks athlete state over time, surfaces who needs attention before it becomes a problem, and connects them to you when they need a real conversation.
          </p>
        </div>
      </section>
      ...
      {/* VAC waitlist */}
      <section id="waitlist" className="flex flex-col items-center px-6 py-14">
        <div className="max-w-2xl w-full">
          ...
          <p className="font-inter text-base text-[#4A443E] leading-relaxed mb-4">
            VAC — Virtual Assistant Coach — is LaRue deployed as your assistant coach. He knows every athlete on your roster from day one, tracks their readiness state across the season, and handles the intake and monitoring work that currently lives in your head or doesn&apos;t get done at all.
          </p>
          <p className="font-inter text-base text-[#4A443E] leading-relaxed mb-8">
            We are onboarding a small cohort of coaches for the pilot. If you work with competitive athletes and want to be part of the first class, apply below.
          </p>
          <Link
            href="https://momentumlabs.coach"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block px-8 py-4 bg-[#B8821A] text-white font-syne font-semibold text-base rounded hover:bg-[#a07115] transition-colors"
          >
      ...
      <section className="flex flex-col items-center px-6 py-14">
        <div className="max-w-2xl w-full">
          ...
          <Link href="https://momentumlabs.coach" target="_blank" rel="noopener noreferrer" className="font-mono text-xs text-[#B8821A] tracking-widest uppercase hover:underline">momentumlabs.coach &rarr;</Link>
        </div>
      </section>
